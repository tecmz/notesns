...
- [系统优化] 后台Dashboard布局优化
- [系统优化] 用户评论后台Dashboard布局优化
...
- [新功能] 后台内容审核新增业务跳转和ID显示
- [新功能] 内容审核增加Biz，方便业务接入
- [新功能] 网站简单统计
- [新功能] 魔众邮箱、验证码、SMTP默认集成
- [系统优化] 后台用户管理操作方式优化
...
- [新功能] 默认分类功能，历史文章自动归类到默认分类
- [新功能] 文章审核中文案调整
- [新功能] 后台首页新增用户评论统计
- [新功能] 文章底部作者头像和名字加个链接可以点进去作者主页
- [系统优化] 接口异常返回信息提示
- [系统优化] 文件上传获取路径为空问题
...
- [新功能] Bugfix 修复支付方式不存在Bug
- [新功能] Feature 文件选择器增加分类搜索功能
- [新功能] Feature 后台增加阿里云OSS上传
- [新功能] Feature 统计代码可设定head或body
- [新功能] Feature 专题移除文章
- [新功能] Bugfix 文章图片居中对齐
- [新功能] Feature 富文本增加音频和视频
- [新功能] Feature 首页增加推荐文章、热论文章
- [新功能] Bugfix 调整界面几处样式
...
- [新功能] Bugfix 文章删除时用户喜欢不显示
- [新功能] Bugfix 专题字数太多时文字溢出
...
- [新功能] Feature 增加小程序接口
- [新功能] Feature 打赏接入微信支付
- [新功能] Feature 引导安装提示用语不当
- [新功能] Feature 调整关注专题和用户菜单
- [新功能] Feature APP更新版本检测接口
- [新功能] Feature APP版本显示页面
...
- [新功能] Bugfix 修复几处XSS
- [新功能] Feature 增加手机版适配功能
- [新功能] Feature 增加文章举报功能
- [新功能] Feature M站首页增加最热文章和最新文章
- [新功能] Feature 手机写文章页面优化
- [新功能] Feature 增加微信页面分享设置
- [新功能] Feature 手机端接入打赏功能
- [新功能] Feature 用户在线消息轮训
- [新功能] Feature 手机端增加到专题
...
- [新功能] Feature 增加专题导航
- [新功能] Bugfix 写作模式编辑器高度不正确
- [新功能] Feature 增加打赏功能
- [新功能] Feature 已登录账户绑定QQ、微博、微信功能
- [新功能] Feature 升级后台样式
- [新功能] Feature 文章、专题、用户搜索功能
- [新功能] Feature 增加用户提现功能
...
- [新功能] Feature 头像PNG支持
- [新功能] Feature 增加旧版浏览器升级提醒
- [新功能] Feature 增加后台管理功能
- [新功能] Feature 头像插件升级
- [新功能] Feature 增加用户上传图片水印功能
...
[http://notesns.demo.tecmz.com/](http://notesns.demo.tecmz.com/)

## 下载试用

[http://tecmz.com/product/notesns](http://tecmz.com/product/notesns)